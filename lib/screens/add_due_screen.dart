...
class AddDue extends StatefulWidget {
  @override
  _AddDueState createState() => _AddDueState();
}
                          ...
                          TextFormField(
                            ...
                            validator: (val) {
                              if (val.length > 6) {
                                ...
                                return "The due Should be Smaller Than 1000000 Letter";
                              } else if (val == "0") {
                                showToast("Due value Should be Larger Than 0");
                                return "The debt Should be Larger Than 0 LE";
                              } else if (val == null || val == "") {
                                showToast("Please Enter The Due Value  ");
                                return "Please Enter Value Of Due  ";
                              } else {
                                return null;
                              }
                            },
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: RaisedButton(
                        onPressed: () async {
                          if (date == null) {
                            showToast("Please Choose Date oF Due");
                          } else {
                            if (_myFormKey.currentState.validate() == true) {
                              ...
                              int id = await helper.addDue(due);
                              print(id);
