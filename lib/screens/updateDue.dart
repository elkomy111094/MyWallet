...
class UpdateDue extends StatefulWidget {
  Due due;

  @override
  _UpdateDueState createState() => _UpdateDueState();

  UpdateDue(Due theDue) {
    this.due = theDue;
  }
}

class _UpdateDueState extends State<UpdateDue> {
  DbHelper helper;
  ...
  void initState() {
    ...
    tName.text = widget.due.name;
    tVal.text = (widget.due.value).toString();
    tReason.text = widget.due.reason;

    date = widget.due.date;
  }
              ...
              child: Column(
                ...
                children: [
                  TextFormField(
                    validator: (val) {
                      if (val.length > 100) {
                        ...
                        showToast("Please Enter Name Of Debtor");
                  ...
                  TextFormField(
                    validator: (val) {
                      if (val.length > 1000) {
                        ...
                        return "The Reason Should be Larger Than 10 Letter";
                      } else if (val == null) {
                        showToast("Please Reason Of Due");
                  ...
                  TextFormField(
                    validator: (val) {
                      if (val.length > 10) {
                        showToast("Value Is Too Large ");
                        return "The debt Should be Smaller Than 10000000000 Letter";
                      } else if (val.length <= 0) {
                        showToast("No Due value");
                        return "The Due Should be Larger Than 0 LE";
                      } else if (val == null) {
